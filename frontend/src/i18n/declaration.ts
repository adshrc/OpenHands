...
export enum I18nKey {
  ...
  SETTINGS$ASANA_ACCESS_TOKEN = "SETTINGS$ASANA_ACCESS_TOKEN",
  SETTINGS$ASANA_ACCESS_TOKEN_PLACEHOLDER = "SETTINGS$ASANA_ACCESS_TOKEN_PLACEHOLDER",
  SETTINGS$ASANA_ACCESS_TOKEN_HIDDEN = "SETTINGS$ASANA_ACCESS_TOKEN_HIDDEN",
  SETTINGS$ASANA_AGENT_USER_GID = "SETTINGS$ASANA_AGENT_USER_GID",
  SETTINGS$ASANA_WORKSPACE_GID = "SETTINGS$ASANA_WORKSPACE_GID",
  SETTINGS$ASANA_PROJECT_GID = "SETTINGS$ASANA_PROJECT_GID",
  SETTINGS$ASANA_GID_PLACEHOLDER = "SETTINGS$ASANA_GID_PLACEHOLDER",
  SETTINGS$ASANA_WEBHOOK_STATUS = "SETTINGS$ASANA_WEBHOOK_STATUS",
  SETTINGS$ASANA_CHECKING_STATUS = "SETTINGS$ASANA_CHECKING_STATUS",
  SETTINGS$ASANA_CONFIGURE_FIRST = "SETTINGS$ASANA_CONFIGURE_FIRST",
  SETTINGS$ASANA_ERROR_CHECKING_STATUS = "SETTINGS$ASANA_ERROR_CHECKING_STATUS",
  SETTINGS$ASANA_WEBHOOK_ACTIVE = "SETTINGS$ASANA_WEBHOOK_ACTIVE",
  SETTINGS$ASANA_WEBHOOK_INACTIVE = "SETTINGS$ASANA_WEBHOOK_INACTIVE",
  SETTINGS$ASANA_WEBHOOK_NOT_REGISTERED = "SETTINGS$ASANA_WEBHOOK_NOT_REGISTERED",
  SETTINGS$ASANA_MONITORING = "SETTINGS$ASANA_MONITORING",
  SETTINGS$ASANA_LAST_SUCCESS = "SETTINGS$ASANA_LAST_SUCCESS",
  SETTINGS$ASANA_CREATING = "SETTINGS$ASANA_CREATING",
  SETTINGS$ASANA_RECREATE_WEBHOOK = "SETTINGS$ASANA_RECREATE_WEBHOOK",
  SETTINGS$ASANA_CREATE_WEBHOOK = "SETTINGS$ASANA_CREATE_WEBHOOK",
  SETTINGS$ASANA_WEBHOOK_FAILED = "SETTINGS$ASANA_WEBHOOK_FAILED",
  SETTINGS$ASANA_WEBHOOK_SUCCESS = "SETTINGS$ASANA_WEBHOOK_SUCCESS",
  SETTINGS$ASANA_WEBHOOK_DESCRIPTION = "SETTINGS$ASANA_WEBHOOK_DESCRIPTION",
